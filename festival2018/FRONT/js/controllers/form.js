app.controller("formulario",['$scope','$rootScope','$http','$window',function($scope,$rootScope,$http,$window){
        ...
        var init = function() {
          ...
          var req = {
            method : "POST" ,
            url :  "http://apirestsonpm.jonathanarc.net/apirest/busqueda/lugaresArea" , 
            data: {
        ...
        $scope.update = function() {
          ...
          var req = {
            method : "POST" ,
            url :  "http://apirestsonpm.jonathanarc.net/apirest/altaParticipante" , 
            data: {
        ...
        $scope.seleccionaaBoton = function(lug) {
          ...
          if ($scope.botonesLugar[lug]) {
            ...
            if ($scope.lugar.length == 0 ) {
              ...
              var req = {
                method : "POST" ,
                url :  "http://apirestsonpm.jonathanarc.net/apirest/busqueda/validarLugar" , 
                data: {
