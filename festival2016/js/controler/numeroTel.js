app.directive('isNumbers',['$compile','$rootScope', function($compile,$rootScope) {
    return {
      restrict: 'E',
      scope: {
        myNgModel: '='
      ...
      compile: function(element, attrs) {
                 ...
                 var e = angular.element('<input type="Text" min="10" max="14" class="formu" name="telefono" ng-blur="errores()" ng-model="'+attrs.myNgModel+'"  required/>');
                 element.append(e);
